...
/* SWAPFPN */
#define PAGING64_SWP_LOBIT NBITS(PAGING64_PAGESZ)
#define PAGING64_SWP_HIBIT (NBITS(PAGING_MEMSWPSZ) - 1)
...
#define PAGING64_SWP_MASK         GENMASK64(PAGING64_SWP_HIBIT,PAGING64_SWP_LOBIT)
...
#define PAGING64_SWP(x)  GETVAL(x,PAGING64_SWP_MASK,PAGING64_SWP_LOBIT)
